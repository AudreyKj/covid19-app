  ...
  return (
    <div className="info">
      ...
      <p className="info_text">
        This website is a collective gathering of emotions related to the
        COVID-19 outbreak. <br /> <br /> You can submit all the fears, dreams,
        hopes you have regarding the situation and browse through the collection
